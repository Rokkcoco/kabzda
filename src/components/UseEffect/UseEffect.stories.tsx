...
// так же useEffect работает асинхронно, а componentDidMount синхронно, и clean-up будет срабатывать перед повторным запуском эффекта (если он срабатывает при обновлениях)
    return <>
       text: {text}
    </>
}